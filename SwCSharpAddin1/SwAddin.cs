...
namespace SwCSharpAddin1
{
  ...
  /// </summary>
  [Guid("c7b0b30a-5fad-4321-ab7d-0d36a228bd75"), ComVisible(true)]
  [SwAddin(
  ...
  public class SwAddin : ISwAddin
  {
    ...
    ISldWorks m_iSwApp = null;
    ICommandManager m_iCmdMgr = null;
    int m_addinID = 0;
    BitmapHandler m_iBmp;
    int registerID;
    ...
    {
      m_iSwApp = (ISldWorks)ThisSW;
      m_addinID = cookie;

      //Setup callbacks
      m_iSwApp.SetAddinCallbackInfo(0, this, m_addinID);

      #region Setup the Command Manager
      m_iCmdMgr = m_iSwApp.GetCommandManager(cookie);
      AddCommandMgr();
      #endregion

      #region Setup the Event Handlers
      SwEventPtr = (SolidWorks.Interop.sldworks.SldWorks)m_iSwApp;
    ...
    public bool DisconnectFromSW()
    {
      ...
      System.Runtime.InteropServices.Marshal.ReleaseComObject(m_iCmdMgr);
      m_iCmdMgr = null;
      System.Runtime.InteropServices.Marshal.ReleaseComObject(m_iSwApp);
      m_iSwApp = null;
    ...
    public void RemoveCommandMgr()
    {
      ...
      m_iCmdMgr.RemoveCommandGroup(mainCmdGroupID);
      m_iCmdMgr.RemoveFlyoutGroup(flyoutGroupID);
    }
    ...
    public void CreateCube()
    {
      ...
      string partTemplate = m_iSwApp.GetUserPreferenceStringValue((int)swUserPreferenceStringValue_e.swDefaultTemplatePart);
      if ((partTemplate != null) && (partTemplate != ""))
      {
        IModelDoc2 modDoc = (IModelDoc2)m_iSwApp.NewDocument(partTemplate, (int)swDwgPaperSizes_e.swDwgPaperA2size, 0.0, 0.0);
    ...
    {
      FlyoutGroup flyGroup = m_iCmdMgr.GetFlyoutGroup(flyoutGroupID);
    ...
    {
      m_iSwApp.SendMsgToUser("Flyout command 1");
    }
    ...
    {
      ModelDoc2 modDoc = (ModelDoc2)m_iSwApp.GetFirstDocument();
      while (modDoc != null)
      {
